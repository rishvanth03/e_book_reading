...
import 'package:e_book_reader/json/favourite_json.dart';
import 'package:e_book_reader/json/home_json.dart';
import 'package:e_book_reader/pages/book_detail_page.dart';
import 'package:e_book_reader/theme/colors.dart';
                                ...
                                onTap: () {
                                  setState(() {
                                    specialForYouJson[index]['favourite'] =
                                        !specialForYouJson[index]['favourite'];
                                    if (specialForYouJson[index]['favourite'] ==
                                        true) {
                                      favouriteBooksJson.add(
                                        {
                                          "img": specialForYouJson[index]
                                              ['img'],
                                          "price": specialForYouJson[index]
                                                  ['price']
                                              .toString(),
                                          "title": specialForYouJson[index]
                                              ['title'],
                                          "sub_title": specialForYouJson[index]
                                              ['sub_title'],
                                          "author_name":
                                              specialForYouJson[index]
                                                  ['author_name'],
                                          "rate": specialForYouJson[index]
                                              ['rate'],
                                          "page": specialForYouJson[index]
                                              ['page']
                                        },
                                      );
                                    }
