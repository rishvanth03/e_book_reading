...
import 'package:e_book_reader/pages/playing_now_page.dart';
...
class _BookDetailPageState extends State<BookDetailPage> {
  void saveFile(Uint8List data, String filePath) {
    // For web applications
    if (Platform.isWindows) {
      print('Saving files is not supported in web applications.');
    } else {
      // For other platforms
                              ...
                              children: [
                                ...
                                IconButton(
                                    onPressed: () async {
                                      ...
                                      final pdfPath = 'file/1.pdf';

                                      try {
                                        // Load the file from the asset bundle
                                        final ByteData data =
                                        ...
                                        final filePath =
                                            '${directory.path}/downloaded_file.pdf';
